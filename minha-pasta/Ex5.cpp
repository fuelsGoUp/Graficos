...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		...
		-0.5, -0.5, 0.0, 1.0, 0.0, 0.0, // V0 - vermelho
		 0.5, -0.5, 0.0, 0.0, 1.0, 0.0, // V1 - verde
		 0.0,  0.5, 0.0, 0.0, 0.0, 1.0, // V2 - azul
		 // T1
		-3.5, -0.5, 0.0, 1.0, 0.0, 0.0, // V0 - vermelho
		-2.5, -0.5, 0.0, 0.0, 1.0, 0.0, // V1 - verde
		-3.0,  0.5, 0.0, 0.0, 0.0, 1.0, // V2 - azul
