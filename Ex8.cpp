...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		// x   y     z   r   g    b
		// T0
		-0.5, -0.5, 0.0, 1.0, 1.0, 1.0,    // v0
		 0.5, -0.5, 0.0, 1.0, 1.0, 1.0,    // v1
		 0.5,  0.5, 0.0, 1.0, 1.0, 1.0,	   // v2
		// T1
        -0.5,  -0.5, 0.0, 1.0, 1.0, 1.0,    //v3
         0.5,   0.5, 0.0, 1.0, 1.0, 1.0,    //v4
        -0.5,   0.5, 0.0, 1.0, 1.0, 1.0,	   //v5
		// T2
		-0.6,   0.5, 0.0, 1.0, 0.0, 0.0,    //v3
    	 0.0,   1.0, 0.0, 1.0, 0.0, 0.0,    //v4
         0.6,   0.5, 0.0, 1.0, 0.0, 0.0,   //v5
		// T3
		-0.4,  -0.5, 0.0, 1.0, 0.0, 0.0,    //v3
    	 0.1,   0.2, 0.0, 1.0, 0.0, 0.0,    //v4
        0.1,    -0.5, 0.0, 1.0, 0.0, 0.0,   //v5
		// T4
		-0.4,   0.2, 0.0, 1.0, 0.0, 0.0,    //v3
    	-0.4,  -0.5, 0.0, 1.0, 0.0, 0.0,    //v4
        0.1,    0.2, 0.0, 1.0, 0.0, 0.0,   //v5
	};
